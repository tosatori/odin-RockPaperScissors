This Exercise is part of the Odin Project. It`s the first project in the foundations tracks basic javascript section. The goal of this exercise is to build a simple "Rock, Paper, Scissor" game from scratch.
